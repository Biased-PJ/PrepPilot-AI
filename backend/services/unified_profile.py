...
def get_unified_stats(user_email):
    ...
    for profile in profiles:
        ...
        if platform == "leetcode":
            ...
            unified["easy"] += stats.get(
                "easy",
                0
            )

            unified["medium"] += stats.get(
                "medium",
                0
            )

            unified["hard"] += stats.get(
                "hard",
                0
            )

            unified["total"] += stats.get(
                "total",
                0
            )
        ...
        # =================================================
            ...
            unified["github_repos"] += stats.get(
                "repos",
                0
            )

            unified["github_followers"] += stats.get(
                "followers",
                0
            )

            unified["github_stars"] += stats.get(
                "stars",
                0
            )
    ...
    unified["coder_score"] = calculate_coder_score(
        unified
    )
